package com.wangduoyu.lib.commonlib.widget.placeholder;
...
import com.wangduoyu.lib.commonlib.widget.loading.LoadingIndicatorView;
...
public class EmptyView extends LinearLayout implements PlaceHolderView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mColor[0] = a.getInt(R.styleable.EmptyView_comLoadingColor, R.color.colorBaseAccent);
